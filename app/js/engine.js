...
export function newBattle(mode, defsJson, indicesJson, teamsJson, humansJson, seed, firstActor) {
  return wasm.init_battle(mode, defsJson, indicesJson, teamsJson, humansJson, seed, firstActor != null ? firstActor : -1);
}
